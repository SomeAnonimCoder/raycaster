        ...
        while alpha < player.fov / 2 + player.view:
            ...
            while 0 < x < mapFB.w - 1 and 0 < y < mapFB.h - 1:
                ...
                if map.empty(x / mapCellW, y / mapCellH):
                    ...
                    if (-1000 / dist * cos(
                        beta) + screenFB.w / 2 > 0 and rayNum * screenCellH > 0 and 1000 / dist * cos(
                        beta) + screenCellW / 2 < screenFB.w and (rayNum + 1) * screenFB.h / RAY_NUM < screenFB.h):
                        screenFB.drawTexture(
                            ...
                            "renderer/res/" + str(map.get(x / mapCellW, y / mapCellH) % 4 + 1) + ".jpg", x, y, mapCellW,
                            mapCellH)
                        break
